...
function clickBtn() {
    ...
    if (userInp <= 1) {
        ...
        alert('Enter a number less than 13 to play more comfortably.');
        // h2.innerHTML = "Refresh to start again."
...
function checkAns() {
    ...
    if (userSeq[currentInx] === gameSeq[currentInx]) {
     ...
     Your score was ${level - 1}`;
        ...
        setTimeout(function () {
            document.querySelector("body").style.backgroundColor = "rgb(248, 156, 156)";
        }, 250);
